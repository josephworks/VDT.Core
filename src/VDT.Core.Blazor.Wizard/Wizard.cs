...
public class Wizard : ComponentBase
{
    ...
    /// </summary>
    [Parameter]
    public string? TitleContainerClass { get; set; }
    ...
    /// </summary>
    [Parameter]
    public string? StepTitleContainerClass { get; set; }

    /// <summary>
    ///     CSS class to apply to the wizard step titles
    /// </summary>
    [Parameter]
    public string? StepTitleClass { get; set; }

    /// <summary>
    ///     CSS class to apply to the title of the active wizard step
    /// </summary>
    [Parameter]
    public string? ActiveStepTitleClass { get; set; }
    ...
    /// </summary>
    [Parameter]
    public string? ButtonCancelClass { get; set; }
    ...
    /// </summary>
    [Parameter]
    public string? ButtonPreviousClass { get; set; }

    /// <summary>
    ///     Text that is displayed on the button for the previous step
    /// </summary>
    [Parameter]
    public string ButtonPreviousText { get; set; } = "Previous";

    /// <summary>
    ///     CSS class to apply to the button for the next step
    /// </summary>
    [Parameter]
    public string? ButtonNextClass { get; set; }
    ...
    /// </summary>
    [Parameter]
    public RenderFragment<WizardLayoutContext>? Layout { get; set; }
    ...
    internal WizardStep? ActiveStep => ActiveStepIndex.HasValue && StepsInternal.Count > ActiveStepIndex.Value
        ? StepsInternal[ActiveStepIndex.Value]
        : null;
    ...
    internal async Task AddStep(WizardStep step)
    {
        if (!StepsInternal.Contains(step))
        {
            ...
            if (StepsInternal.Count == 1) await ActiveStep!.Initialize();
        }
    }
