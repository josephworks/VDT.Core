...
public class WizardLayoutContext
{
    ...
    /// </summary>
    public RenderFragment Title => builder => { builder.AddContent(1, wizard.TitleContent); };
    ...
    {
        if (wizard.ActiveStep != null) builder.AddContent(1, wizard.ActiveStep.ChildContent);
    };
}